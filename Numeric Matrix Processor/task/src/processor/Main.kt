    ...
    outer@while (true) {
        ...
        when (scanner.nextInt()) {
            ...
            1 -> {
                ...
                for (i in 0 until bRows) {
                    ...
                    for (j in 0 until bColumns) {
                        matrixA[j + bColumns * i] += scanner.nextInt()
                    }
                }
            ...
            3 -> {
                ...
                val matrixB = Array(aRows * aColumns) { 0 }
                println("Enter second matrix:")
                for (i in 0 until bRows) {
                    print("> ")
                    for (j in 0 until bColumns) {
                        matrixB[j + bColumns * i] += scanner.nextInt()
                    }
                }
                ...
                for (i in 0 until aRows) {
                    for (j in 0 until bColumns) {
                        ...
                        //
                        val rowInA = Array(aColumns) { 0 }
                        val columnInB = Array(bRows) { 0 }
